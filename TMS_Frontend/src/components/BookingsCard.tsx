export function BookingCard() {
  return (
    <div className="bg-white p-6 rounded shadow space-y-2  w-[70vw] mx-auto">
      {/* Route */}
      <div className="font-semibold text-lg">New York → Miami</div>
      ...
      <div className="flex items-center justify-between text-sm text-gray-700">
        <div>
          ...
          <div className="text-xs">Times Square Terminal</div>
        </div>
        ...
        <div>
          ...
          <div className="text-xs">Downtown Miami Terminal</div>
        </div>
      </div>
