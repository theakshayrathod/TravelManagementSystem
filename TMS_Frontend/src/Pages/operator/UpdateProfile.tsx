...
export function OperatorProfileUpdate():JSX.Element{
  ...
  return (
    ...
    <div className="  mt-10 rounded-md shadow-lg bg-gray-100 mx-5 border-2">
          <h2 className="text-3xl font-bold  text-gray-900 mx-35 ">Bus Operator Profile</h2>    
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            ...
            <div className="col-span-full">
              <label htmlFor="licens" className="block text-sm/6 font-medium text-gray-900">
                Licens No
              </label>
              <div className="mt-2">
                <input
